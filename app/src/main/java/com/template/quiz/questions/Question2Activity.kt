...
class Question2Activity : AppCompatActivity() {
    ...
    private fun setOnClicks() {
        answ1.setOnClickListener {
            if (1 == QuestionManager.getAnswer(2))
        ...
        answ2.setOnClickListener {
            if (2 == QuestionManager.getAnswer(2))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
        }
        ...
        answ3.setOnClickListener {
            if (3 == QuestionManager.getAnswer(2))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
        }
        ...
        answ4.setOnClickListener {
            if (4 == QuestionManager.getAnswer(2))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
    ...
    private fun showAnswDialog() {
        val answer = "Simone Biles from United States had won an individual Gold medal in the Women’s individual event of Artistic gymnastics in 2016 Rio Olympics. Who had won a Gold Medal in the Men’s individual event of Trampoline gymnastics in the 2016 Rio Olympics?"
