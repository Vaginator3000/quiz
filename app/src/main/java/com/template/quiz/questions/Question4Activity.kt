...
class Question4Activity : AppCompatActivity() {
    ...
    private fun setOnClicks() {
        answ1.setOnClickListener {
            if (1 == QuestionManager.getAnswer(4))
        ...
        answ2.setOnClickListener {
            if (2 == QuestionManager.getAnswer(4))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
        }
        ...
        answ3.setOnClickListener {
            if (3 == QuestionManager.getAnswer(4))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
        }
        ...
        answ4.setOnClickListener {
            if (4 == QuestionManager.getAnswer(4))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
    ...
    private fun showAnswDialog() {
        val answer = "BWF regularly organise 7 major international events regularly. They are- Olympic Games, World Championships, World Junior Championships, Para-Badminton World Championships, Thomas Cup, Uber Cup and Sudirman Cup."
