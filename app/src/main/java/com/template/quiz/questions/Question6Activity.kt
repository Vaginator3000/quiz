...
class Question6Activity : AppCompatActivity() {
    ...
    private fun setOnClicks() {
        answ1.setOnClickListener {
            if (1 == QuestionManager.getAnswer(6))
        ...
        answ2.setOnClickListener {
            if (2 == QuestionManager.getAnswer(6))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
        }
        ...
        answ3.setOnClickListener {
            if (3 == QuestionManager.getAnswer(6))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
        }
        ...
        answ4.setOnClickListener {
            if (4 == QuestionManager.getAnswer(6))
                actionsIfAnswerIsCorrent()
            else
                actionsIfAnswerIsWrong(it)
    ...
    private fun showAnswDialog() {
        val answer = "Australia has hosted the Commonwealth Games five times, this is more times than any other nation."
